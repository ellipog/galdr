...
LangString featureTitle ${LANG_ENGLISH} "FEATURE CONFIGURATION"
LangString featureSubtitle ${LANG_ENGLISH} "Choose which features to enable in galdr."
LangString discordLabel ${LANG_ENGLISH} "Discord Rich Presence (shows what you're converting on your Discord profile)"
LangString crtLabel ${LANG_ENGLISH} "CRT scan-line retro effect"
LangString runeLabel ${LANG_ENGLISH} "Rune ornament in titlebar"
LangString transitionsLabel ${LANG_ENGLISH} "Page transition animations"
